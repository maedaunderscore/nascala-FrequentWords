...
心の準備をしてください。(10〜20分くらい？)
  ...
  1. サンプルコードの取得
    #+BEGIN_SRC text
      > git clone https://github.com/maeda-/nascala-FrequentWord.git
      (gitがない場合はhttps://github.com/maeda-/nascala-FrequentWordからZIPをダウンロード)
    #+END_SRC
    
  2. sbtの起動と実行
    #+BEGIN_SRC text
    > cd nascala-FrequentWord
